...
const InterviewsMasterPage = ({ user }: { user: User }) => {
      ...
      <div className="formation-page py-10 lg:mt-10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 dark:text-white">
            Vous devez avoir 2 crédits pour accéder à cette formation. Veuillez vérifier votre compte.
          </div>
        </div>
      </div>
    );
  ...
  const [credits, setCredits] = useState(2); // Start with 2 credits
...
export default InterviewsMasterPage;
