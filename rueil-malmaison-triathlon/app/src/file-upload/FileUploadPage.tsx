      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-4xl text-center'>
          <h2 className='mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl dark:text-white'>
            Mes <span className='text-yellow-500'>Documents</span>
          </h2>
        </div>
        <p className='mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 dark:text-white'>
          C'est ici que vous devez télécharger votre certificat médical d'aptitude au triathlon. Ce document est essentiel pour valider votre inscription et garantir votre sécurité pendant les entraînements et compétitions. Merci de le télécharger ici pour finaliser votre inscription 🤝
        </p>
