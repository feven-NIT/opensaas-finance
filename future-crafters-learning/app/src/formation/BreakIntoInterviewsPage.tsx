...
const BreakIntoInterviewsPage = ({ user }: { user: User }) => {
  // Vérifier si l'utilisateur a des crédits avant d'afficher la page
  if (user.credits !== 1) {
    return (
      <div className="formation-page py-10 lg:mt-10">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-6 max-w-2xl text-center text-lg leading-8 text-gray-600 dark:text-white">
            Vous devez avoir 1 crédits pour accéder à cette formation. Veuillez vérifier votre compte.
          </div>
        </div>
      </div>
    );
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="my-8 text-center">
          <h3 className="text-3xl font-bold text-gray-900 dark:text-white">
            Votre Abonnement : <span className="text-yellow-500">{user.credits}</span>
          </h3>
        </div>
...
export default BreakIntoInterviewsPage;
